...
|----------|---------|-----------------|
| [docs/README.md](docs/README.md) | Présentation générale, features, sources | Vue d'ensemble |
| [docs/API.md](docs/API.md) | Guide intégration API (13 langages) | Intégration externe |
| [docs/OAUTH.md](docs/OAUTH.md) | OAuth2, scopes, rate limiting | Auth API |
| [docs/PRIVE.md](docs/PRIVE.md) | **Livre blanc complet** (1429 lignes) | Maîtrise totale |
| [docs/INSTALL.md](docs/INSTALL.md) | Guide installation | Déploiement |
| [docs/TROUBLESHOOT.md](docs/TROUBLESHOOT.md) | Guide dépannage | Problèmes |

## Documentation technique

| Document | Contenu | Quand l'utiliser |
|----------|---------|-----------------|
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | Architecture, flux, middleware, conventions | Comprendre le code |
| [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md) | Déploiement Docker/systemd, maintenance | Déployer/maintenir |
| [docs/SECURITY.md](docs/SECURITY.md) | Sécurité OWASP, secrets, couches | Audit sécurité |

## Zone → Document

| Zone du projet | Document à lire |
|----------------|-----------------|
| `server.py` | [ARCHITECTURE.md](docs/ARCHITECTURE.md) |
| `agent.py` | [ARCHITECTURE.md](docs/ARCHITECTURE.md) + [PRIVE.md](docs/PRIVE.md) |
| `routes/` | [ARCHITECTURE.md](docs/ARCHITECTURE.md) |
| `core/` | [ARCHITECTURE.md](docs/ARCHITECTURE.md) |
| `sources/` | [ARCHITECTURE.md](docs/ARCHITECTURE.md) |
| `clients.py` | [OAUTH.md](docs/OAUTH.md) + [PRIVE.md](docs/PRIVE.md) |
| `admin/` | [PRIVE.md](docs/PRIVE.md) (section 8) |
| Auth/Security | [OAUTH.md](docs/OAUTH.md) + [SECURITY.md](docs/SECURITY.md) |
| Déploiement | [DEPLOYMENT.md](docs/DEPLOYMENT.md) |
| Tests | [PRIVE.md](docs/PRIVE.md) (section 10) |
