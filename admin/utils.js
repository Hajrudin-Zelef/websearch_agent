/* ═══════════════════════════════════════════════════
   WEBSEARCH AGENT — UTILS
   Shared utilities for admin & chat interfaces
   ═══════════════════════════════════════════════════ */
...
// ─── Observe DOM for new icons ───
function observeIcons(container) {
  if (typeof lucide === 'undefined') return;
  let pending = false;
  const observer = new MutationObserver((mutations) => {
    // Ignore mutations we caused ourselves (SVG nodes added by lucide)
